...
# main からの直接インポートを削除し、関数内でインポートするように変更

def simulate_games(num_games=10, output_file="simulation_results.txt"):
    """指定された回数の試合をシミュレーションし、結果をファイルに出力する"""
    # main モジュールを必要な時点でインポート
    from main import create_sample_teams

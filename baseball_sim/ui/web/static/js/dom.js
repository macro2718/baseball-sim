...
export const elements = {
  ...
  simulationCard: document.getElementById('simulation-card'),
  simulationForm: document.getElementById('simulation-form'),
  simulationGamesInput: document.getElementById('simulation-games'),
  simulationRunButton: document.getElementById('simulation-run'),
  ...
  simulationTable: document.getElementById('simulation-team-table'),
  simulationTableBody: document.querySelector('#simulation-team-table tbody'),
  simulationRecentSection: document.getElementById('simulation-recent-section'),
  simulationRecentList: document.getElementById('simulation-recent'),
  simulationLogSection: document.getElementById('simulation-log-section'),
  simulationLogList: document.getElementById('simulation-log'),
